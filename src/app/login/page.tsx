      ...
      <div className="w-full max-w-[430px] relative z-10 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mb-16 w-full">
          <img 
            ...
            className="w-[240px] md:w-[260px] object-contain mb-8 drop-shadow-[0_0_20px_rgba(255,255,255,0.1)]" 
          />
        ...
        <div className="w-full bg-[#0B1120]/80 backdrop-blur-xl border border-white/10 rounded-[32px] py-[48px] px-[40px] shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden flex flex-col min-h-[560px]">
          ...
          <form onSubmit={handleLogin} className="w-full space-y-6 flex-1 flex flex-col justify-center">
            {error && (
            ...
            <div className="w-full space-y-5">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full h-14 bg-black/50 border border-white/10 rounded-xl px-4 text-sm text-white placeholder-white/30 focus:outline-none focus:border-cyan-400 transition-all"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full h-14 bg-black/50 border border-white/10 rounded-xl pl-4 pr-12 text-sm text-white placeholder-white/30 focus:outline-none focus:border-cyan-400 transition-all tracking-wider"
                    placeholder="••••••••"
                  />
                  <button 
                    type="button" 
            ...
            <button 
              type="submit"
              disabled={loginState !== 'idle'}
              className="w-full h-14 mt-8 bg-[#06b6d4] text-black font-black rounded-xl text-xs uppercase tracking-[0.2em] shadow-[0_0_20px_rgba(6,182,212,0.4)] hover:brightness-110 active:scale-[0.98] transition-all disabled:opacity-100 disabled:scale-100 relative overflow-hidden flex items-center justify-center"
            >
          ...
          <button 
            ...
            disabled={loginState !== 'idle'}
            className="w-full h-14 bg-transparent border border-white/20 text-white font-bold rounded-xl text-xs flex items-center justify-center gap-3 hover:bg-white/5 transition-colors disabled:opacity-50"
          >
