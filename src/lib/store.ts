  ...
  navSections: [
    {
      label: 'Overview',
      items: [
        { id: 'dashboard', label: 'Intelligence', icon: '📊', color: 'blue' },
        { id: 'alerts', label: 'Alerts Hub', icon: '🔔', color: 'red' },
        { id: 'reports', label: 'Analytics', icon: '📋', color: 'purple' },
      ],
    },
    {
      label: 'Financial Flow',
      items: [
        { id: 'pl', label: 'P&L Audit', icon: '📈', color: 'green' },
        { id: 'expenses', label: 'Expenses', icon: '💸', color: 'red' },
        { id: 'loans', label: 'Capital', icon: '🏦', color: 'blue' },
    ...
    },
    {
      ...
      items: [
        { id: 'labor', label: 'Personnel', icon: '👷', color: 'amber' },
        { id: 'livestock', label: 'Livestock', icon: '🐄', color: 'red' },
        { id: 'crops', label: 'Crops', icon: '🌿', color: 'green' },
        { id: 'maintenance', label: 'Infrastructure', icon: '🔧', color: 'purple' },
      ],
    },
    {
      label: 'Data Hub',
      items: [
        ...
        { id: 'documents', label: 'Vault', icon: '📁', color: 'amber' },
        { id: 'settings', label: 'Governance', icon: '⚙️', color: 'gray' },
      ],
    },
  ],
  notifications: [],
