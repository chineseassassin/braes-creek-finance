...
export const BUSINESS_SEGMENTS: BusinessSegment[] = [
  ...
  { id: 'seg-001', name: 'Poultry - Broilers (Meat)', code: 'BROILER', color: '#f59e0b', icon: '🍗' },
  { id: 'seg-002', name: 'Poultry - Layers (Eggs)', code: 'LAYERS', color: '#84cc16', icon: '🥚' },
  ...
  { id: 'seg-007', name: 'Maintenance & Tools', code: 'MAINT', color: '#64748b', icon: '🔧' },
  { id: 'seg-008', name: 'Utilities & Bills', code: 'UTILITIES', color: '#0ea5e9', icon: '⚡' },
  { id: 'seg-009', name: 'Payroll & Labor', code: 'PAYROLL', color: '#14b8a6', icon: '💰' },
  { id: 'seg-010', name: 'Transportation & Fuel', code: 'TRANSPORT', color: '#f97316', icon: '🚛' },
  { id: 'seg-011', name: 'Chemicals & Fertilizer', code: 'CHEM', color: '#d946ef', icon: '🧪' },
  { id: 'seg-012', name: 'Marketing & Sales', code: 'MARKETING', color: '#3b82f6', icon: '📣' },
];

export const EXPENSE_CATEGORIES: ExpenseCategory[] = [
  { id: 'cat-001', name: 'Tools & Equipment', segment_id: 'seg-007', icon: '🔨' },
  { id: 'cat-002', name: 'Light Bill (Electricity)', segment_id: 'seg-008', icon: '💡' },
  { id: 'cat-003', name: 'Water Bill', segment_id: 'seg-008', icon: '💧' },
  { id: 'cat-004', name: 'Property Taxes', segment_id: 'seg-008', icon: '🏠' },
  { id: 'cat-005', name: 'Building Materials', segment_id: 'seg-007', icon: '🧱' },
  { id: 'cat-006', name: 'Poultry Feed (Broilers)', segment_id: 'seg-001', icon: '🌾' },
  { id: 'cat-007', name: 'Poultry Feed (Layers)', segment_id: 'seg-002', icon: '🌾' },
  ...
  { id: 'cat-011', name: 'Vitamins & Medicines', segment_id: 'seg-007', icon: '💊' },
  { id: 'cat-012', name: 'Chemicals / Pesticides', segment_id: 'seg-011', icon: '🧪' },
  { id: 'cat-013', name: 'Fertilizer', segment_id: 'seg-011', icon: '🌱' },
  { id: 'cat-014', name: 'Fuel Costs', segment_id: 'seg-010', icon: '⛽' },
  { id: 'cat-015', name: 'Transportation Costs', segment_id: 'seg-010', icon: '🚛' },
  { id: 'cat-016', name: 'Marketing Cost', segment_id: 'seg-012', icon: '📣' },
  { id: 'cat-017', name: 'Equipment Maintenance', segment_id: 'seg-007', icon: '🔧' },
  { id: 'cat-018', name: 'Payroll Expense', segment_id: 'seg-009', icon: '💵' },
  { id: 'cat-019', name: 'Misc Operational Costs', segment_id: 'seg-hq', icon: '📦' },
];
...
export const LOANS: Loan[] = [
  {
    ...
    segment_id: 'seg-001',
    segment_name: 'Poultry - Broilers (Meat)',
    status: 'active',
...
export const EXPENSES: Expense[] = [
  { id: 'exp-dec-1', date: '2025-12-05', amount: 4500, category_id: 'cat-006', category_name: 'Poultry Feed (Broilers)', vendor_id: 'v-001', vendor_name: 'AgriPro Supplies', segment_id: 'seg-001', segment_name: 'Poultry - Broilers (Meat)', notes: 'Monthly Bulk', description: 'Chicken Feed', payment_method: 'Wire', created_by: 'Admin User', created_at: '2025-12-05T08:00:00Z' },
  { id: 'exp-jan-1', date: '2026-01-15', amount: 12500, category_id: 'cat-002', category_name: 'Light Bill (Electricity)', vendor_id: 'v-004', vendor_name: 'JPS Electric', segment_id: 'seg-008', segment_name: 'Utilities & Bills', notes: 'Jan Utility Flush', description: 'Electricity', payment_method: 'Wire', created_by: 'Admin User', created_at: '2026-01-15T08:00:00Z' },
];

export const SALES: any[] = [
  { id: 'sale-1', date: '2025-12-28', customer: 'Island Groceries', product: 'Eggs', quantity: 1500, unit_price: 12, total_amount: 18000, segment_id: 'seg-002', segment_name: 'Poultry - Layers (Eggs)' },
];
...
export const LIVESTOCK_UNITS: LivestockUnit[] = [
  { id: 'liv-001', animal_type: 'Broiler Chicken', breed: 'Ross 308', quantity: 2500, purchase_date: '2024-11-28', acquisition_date: '2024-12-01', acquisition_cost: 375000, current_value: 875000, mortality_qty: 45, slaughter_date: '2025-01-20', slaughter_qty: 2450, slaughter_weight: 4.5, gross_profit: 500000, net_profit: 425000, segment_id: 'seg-001', location: 'House A & B', notes: 'Batch Alpha - Meats' },
  { id: 'liv-002', animal_type: 'Layer Chicken', breed: 'Lohmann Brown', quantity: 1800, purchase_date: '2024-06-10', acquisition_date: '2024-06-15', acquisition_cost: 540000, current_value: 450000, mortality_qty: 12, segment_id: 'seg-002', location: 'Layer House 1', notes: 'Peak production – Eggs' },
  { id: 'liv-003', animal_type: 'Goat', breed: 'Boer Cross', quantity: 45, purchase_date: '2023-02-20', acquisition_date: '2023-03-01', acquisition_cost: 225000, current_value: 360000, mortality_qty: 2, segment_id: 'seg-003', location: 'Goat Pen 1 & 2', notes: 'Herd expansion' },
  { id: 'liv-004', animal_type: 'Pig', breed: 'Large White', quantity: 22, purchase_date: '2024-04-01', acquisition_date: '2024-04-10', acquisition_cost: 198000, current_value: 440000, mortality_qty: 1, segment_id: 'seg-004', location: 'Pig Sty Block A', notes: 'Growers batch' },
  { id: 'liv-005', animal_type: 'Cattle', breed: 'Jamaica Hope', quantity: 12, purchase_date: '2023-08-10', acquisition_date: '2023-08-20', acquisition_cost: 600000, current_value: 840000, mortality_qty: 0, segment_id: 'seg-005', location: 'Back Pasture', notes: 'Pasture rotation' },
];

export const CROP_TYPES: CropType[] = [
  { id: 'crop-001', name: 'Cassava', variety: 'TMS 30572', season: 'Year-round', planting_date: '2024-10-01', harvest_date: '2025-04-01', area_planted: 2.5, expected_yield: 25000, actual_yield: undefined, unit: 'lbs', segment_id: 'seg-006', status: 'growing', notes: 'Main tuber plot' },
  { id: 'crop-002', name: 'Sweet Potatoes', variety: 'Beauregard', season: 'Dry Season', planting_date: '2024-11-15', harvest_date: '2025-02-15', area_planted: 1.5, expected_yield: 15000, actual_yield: 14200, unit: 'lbs', segment_id: 'seg-006', status: 'harvested', notes: 'Successful yield' },
  { id: 'crop-003', name: 'Tomato', variety: 'Roma VF', season: 'Winter', planting_date: '2025-01-01', harvest_date: '2025-03-30', area_planted: 1.0, expected_yield: 8000, actual_yield: undefined, unit: 'lbs', segment_id: 'seg-006', status: 'growing', notes: 'Strategic focus' },
  { id: 'crop-004', name: 'Cucumber', variety: 'Marketmore', season: 'Spring', planting_date: '2025-02-15', harvest_date: '2025-04-30', area_planted: 0.75, expected_yield: 6000, actual_yield: undefined, unit: 'lbs', segment_id: 'seg-006', status: 'planted', notes: 'High turnover' },
  ...
  { id: 'crop-006', name: 'Sorrel', variety: 'Red Sorrel', season: 'Seasonal', planting_date: '2024-09-01', harvest_date: '2024-12-15', area_planted: 0.75, expected_yield: 3000, actual_yield: 2800, unit: 'lbs', segment_id: 'seg-006', status: 'harvested', notes: 'Holiday yield' },
  { id: 'crop-007', name: 'Scotch Bonnet Pepper', variety: 'Yellow Mix', season: 'Year-round', planting_date: '2024-08-01', harvest_date: '2025-06-01', area_planted: 0.5, expected_yield: 2500, actual_yield: undefined, unit: 'lbs', segment_id: 'seg-006', status: 'growing', notes: 'Premium node' },
];
